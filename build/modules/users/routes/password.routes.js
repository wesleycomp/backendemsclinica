...
passwordRouter.post('/forgot', (0, celebrate_1.celebrate)((_a = {},
    _a[celebrate_1.Segments.BODY] = {
        email: celebrate_1.Joi.string().email().required(),
    },
    _a)), forgotPasswordController.create);
passwordRouter.post('/reset', (0, celebrate_1.celebrate)((_b = {},
    _b[celebrate_1.Segments.BODY] = {
        token: celebrate_1.Joi.string().uuid().required(),
        password: celebrate_1.Joi.string().required(),
        password_validation: celebrate_1.Joi.string().required().valid(celebrate_1.Joi.ref('password')),
    },
