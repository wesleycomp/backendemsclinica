...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var showProfile, user_id, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        showProfile = new ShowProfileService_1.default();
    ...
    ProfileController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, old_password, user_id, updateProfile, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password, old_password = _a.old_password;
                        user_id = request.user.id;
                        updateProfile = new UpdateProfileService_1.default();
