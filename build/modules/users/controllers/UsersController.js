...
var UpdateUserServices_1 = __importDefault(require("../services/UpdateUserServices"));
...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listUser = new ListUserService_1.default();
    ...
    UsersController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, showUsers, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.params.id;
                        showUsers = new ShowUserService_1.default();
                        return [4 /*yield*/, showUsers.execute({ id: id })];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, response.json(user)];
                }
    ...
    UsersController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, perfil, createUser, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password, perfil = _a.perfil;
    ...
    UsersController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id, name, email, password, perfil, resetPassword;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, id = _a.id, name = _a.name, email = _a.email, password = _a.password, perfil = _a.perfil;
                        resetPassword = new UpdateUserServices_1.default();
                    ...
                    case 1:
                        _b.sent();
                        return [2 /*return*/, response.json(resetPassword)];
                }
            });
        });
    };
