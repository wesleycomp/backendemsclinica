...
var UpdateFornecedorService = /** @class */ (function () {
    function UpdateFornecedorService() {
    }
    UpdateFornecedorService.prototype.execute = function (_a) {
        var id = _a.id, nome = _a.nome, cnpj = _a.cnpj, cpf = _a.cpf, inscricaoestadual = _a.inscricaoestadual, inscricaomunicipal = _a.inscricaomunicipal, endereco = _a.endereco, telefone = _a.telefone, email = _a.email, responsavel = _a.responsavel, ehlaboratorio = _a.ehlaboratorio;
        return __awaiter(this, void 0, void 0, function () {
            var fornecedorRepository, fornecedor, fornecedorExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        fornecedorRepository = (0, typeorm_1.getCustomRepository)(FornecedorRepository_1.FornecedorRepository);
                        return [4 /*yield*/, fornecedorRepository.findOne(id)];
                    case 1:
                        fornecedor = _b.sent();
                        if (!fornecedor) {
                            throw new AppError_1.default('Fornecedor não encontrada');
                        }
