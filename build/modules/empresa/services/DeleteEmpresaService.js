...
var DeleteEmpresaService = /** @class */ (function () {
    function DeleteEmpresaService() {
    }
    DeleteEmpresaService.prototype.execute = function (_a) {
        var id = _a.id;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, empresaRepository.remove(empresa)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    return DeleteEmpresaService;
}());
exports.default = DeleteEmpresaService;
