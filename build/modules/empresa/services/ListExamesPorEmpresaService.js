...
var ListExamesPorEmpresaService = /** @class */ (function () {
    function ListExamesPorEmpresaService() {
    }
    ListExamesPorEmpresaService.prototype.execute = function (_a) {
        var empresa_id = _a.empresa_id, data_inicial = _a.data_inicial, data_final = _a.data_final;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        query = asoRepo.createQueryBuilder('a')
                            ...
                            .innerJoin(Paciente_1.default, 'p', 'p.id = a.paciente_id')
                            .innerJoin(ExamesAso_1.default, 'ex', 'ex.aso_id = a.id')
                            .innerJoin('ex.exame', 'e')
                            .where('a.empresa_id = :empresa_id', { empresa_id: empresa_id })
    ...
    return ListExamesPorEmpresaService;
}());
exports.default = ListExamesPorEmpresaService;
