...
var CreatePacientesService = /** @class */ (function () {
    function CreatePacientesService() {
    }
    CreatePacientesService.prototype.execute = function (_a) {
        var empresa_id = _a.empresa_id, funcao_id = _a.funcao_id, categoriatrabalhador_id = _a.categoriatrabalhador_id, matricula = _a.matricula, dataentradaempresa = _a.dataentradaempresa, descricaoatividade = _a.descricaoatividade, nome = _a.nome, cpf = _a.cpf, rg = _a.rg, telefone = _a.telefone, genero = _a.genero, tiposanguineo = _a.tiposanguineo, nacionalidade_id = _a.nacionalidade_id, nis = _a.nis, ctps = _a.ctps, datanascimento = _a.datanascimento, endereco = _a.endereco, email = _a.email;
        return __awaiter(this, void 0, void 0, function () {
            var pacientesRepository, emailExists, paciente;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        pacientesRepository = (0, typeorm_1.getCustomRepository)(PacientesRepository_1.PacientesRepository);
                        return [4 /*yield*/, pacientesRepository.findByCpf(cpf)];
                    case 1:
                        emailExists = _b.sent();
                        if (emailExists) {
                            throw new AppError_1.default('Paciente ja Cadastrado');
                        }
                        paciente = pacientesRepository.create({
    ...
    return CreatePacientesService;
}());
exports.default = CreatePacientesService;
