...
var _NacionalidadeRepository = _interopRequireDefault(require("../typeorm/repositories/NacionalidadeRepository"));
...
class ListCategoriaTrabalhadoresService {
  async execute() {
    ...
    const pacientesRepository = (0, _typeorm.getCustomRepository)(_NacionalidadeRepository.default);
