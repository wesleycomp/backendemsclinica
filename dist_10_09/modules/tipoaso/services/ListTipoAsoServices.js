...
var _TipoAsoRepository = _interopRequireDefault(require("../typeorm/repositories/TipoAsoRepository"));
...
class ListTipoAsoesService {
  async execute() {
    ...
    const pacientesRepository = (0, _typeorm.getCustomRepository)(_TipoAsoRepository.default);
...
var _default = exports.default = ListTipoAsoesService;