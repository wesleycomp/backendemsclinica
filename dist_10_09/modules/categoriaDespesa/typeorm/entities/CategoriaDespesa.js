...
let CategoriaDespesa = (_dec = (0, _typeorm.Entity)('categoria_despesa'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)({
  nullable: true
}), _dec7 = Reflect.metadata("design:type", String), _dec8 = (0, _typeorm.Column)({
  default: true
}), _dec9 = Reflect.metadata("design:type", Boolean), _dec0 = (0, _typeorm.CreateDateColumn)(), _dec1 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec10 = (0, _typeorm.UpdateDateColumn)(), _dec11 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = class CategoriaDespesa {
  constructor() {
...
var _default = exports.default = CategoriaDespesa;