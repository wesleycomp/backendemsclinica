...
var _NaturezaJuridicaRepository = _interopRequireDefault(require("../typeorm/repositories/NaturezaJuridicaRepository"));
...
class ListCategoriaTrabalhadoresService {
  async execute() {
    ...
    const pacientesRepository = (0, _typeorm.getCustomRepository)(_NaturezaJuridicaRepository.default);
