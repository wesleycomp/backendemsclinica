...
class CreateAsoService{
    ...
    public async execute({dataemissaoaso,paciente_id,empresa_id,funcao_id,tipoaso_id,medico_id,resultado,user_edit,temexames,transmissaoesocial,ativo,user_id}: IAso): Promise<Aso>{
