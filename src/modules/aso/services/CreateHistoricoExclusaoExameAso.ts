...
class CreateHistoricoExclusaoExameAso{
    ...
    public async execute({aso_id,exame_id,tipopagamento_id,empresa_id,funcao_id,paciente_id,usuario_id}: IHistoricoExclusaoExameAso): Promise<HistoricoExclusaoExameAso>{
