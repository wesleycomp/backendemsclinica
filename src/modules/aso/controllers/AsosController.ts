...
export default class AsosController{
    ...
    public async create(request: Request, response: Response): Promise<Response>{
        ...
        const {dataemissaoaso,paciente_id,empresa_id,funcao_id,tipoaso_id,medico_id,resultado,user_edit,temexames,transmissaoesocial,ativo,user_id} = request.body;
