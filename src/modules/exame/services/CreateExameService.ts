...
class CreateExameService{
    ...
    public async execute({procedimento_id,name,valoravista,valormedico,valorems,ativo,usuariocadastro,usuarioedicao,localrealizacaoexame}: IExame): Promise<Exame>{
